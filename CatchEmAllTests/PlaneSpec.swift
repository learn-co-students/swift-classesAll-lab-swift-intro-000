...
class PlaneSpec: QuickSpec {
    override func spec() {
        describe("Plane") {
            var plane = Plane(maxAltitude: 43000.0, name: "Boeing 747", weight: 970000.0, maxSpeed: 614.0)

            beforeEach {
                plane = Plane(maxAltitude: 43000.0, name: "Boeing 747", weight: 970000.0, maxSpeed: 614.0)
            }
